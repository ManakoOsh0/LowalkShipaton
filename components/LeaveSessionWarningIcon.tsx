/**
 * Leave-session warning badge — red alert diamond for away-from-venue sheets.
 */
import Svg, { Path } from "react-native-svg";

type LeaveSessionWarningIconProps = {
  size?: number;
};

export function LeaveSessionWarningIcon({ size = 64 }: LeaveSessionWarningIconProps) {
  return (
