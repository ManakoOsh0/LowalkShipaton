/**
 * Custom bottom tab bar — flat card-toned bar with a centred create-session FAB.
 */
    ...
    >
      <View style={{ height: innerHeight }}>
        ...
        >
          <Pressable
            accessibilityRole="button"
            accessibilityLabel="New Focus Node"
            onPress={openNewFocusNode}
            style={({ pressed }) => ({
              width: FAB_SIZE,
              height: FAB_SIZE,
