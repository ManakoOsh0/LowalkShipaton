...
/** SVG source for ClassKindIcon — assets/images/class-graduation-cap.svg */
export const classGraduationCapAssetPath = "assets/images/class-graduation-cap.svg" as const;

/** SVG source for GymKindIcon — assets/images/gym-dumbbell.svg */
...
/** SVG source for HeroWhaleIcon — bundled via constants/pixelWhale.ts */
export const pixelWhaleAssetPath = "assets/images/pixel_whale.svg" as const;
...
/** SVG source for HeroVerificationIcon — bundled via constants/pixelVerification.ts */
export const pixelVerificationAssetPath = "assets/images/pixel_verification.svg" as const;
