...
/** Dev / presentation dataset — three sessions today (gym + library done, class open). */
export function createTestData(): TestDataBundle {
  ...
  const focusNodes: FocusNode[] = [
    ...
    },
    {
      ...
      icon: "library",
      kind: "library",
      schedule: { type: "duration", weekday: todayWeekday, startTime: "10:00", durationHours: 2 },
    ...
    },
    {
      ...
      icon: "class",
      kind: "class",
      schedule: { type: "class", weekday: todayWeekday, startTime: "14:00", endTime: "15:30" },
